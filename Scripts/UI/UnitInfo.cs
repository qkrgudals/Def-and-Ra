...
public class UnitInfo : MonoBehaviour {
    ...
    public VisualElement soldier_Window; // 검사 UI창
    ...
    public VisualElement soldier_SpawnWindow;
    ...
    public VisualElement archer_Window; // 궁수 UI창
    ...
    public VisualElement archer_SpawnWindow;
    ...
    public void DeselectUnitHouse() // 유닛 생성소 선택 해제시
    {
        ...
        switch (enemyManager.currentStage) // 스테이지별 영웅 잠금 조건 (스테이지 2부터 소서리스 해제 / 스테이지 4부터 프리스트 해제)
        {
            case 1: sorceressIcon_Lock.style.display = DisplayStyle.Flex; priestIcon_Lock.style.display = DisplayStyle.Flex; break; // 스테이지 1
            case 2 or 3: sorceressIcon_Lock.style.display = DisplayStyle.None; sorceressIcon.style.display = DisplayStyle.Flex; priestIcon_Lock.style.display = DisplayStyle.Flex; break;
            case 4: priestIcon_Lock.style.display = DisplayStyle.None; priestIcon.style.display = DisplayStyle.Flex; sorceressIcon.style.display = DisplayStyle.Flex; break; // 스테이지 4 
        }
    }
    ...
    public void OnSwordMasterImageClick() {
        ...
        gameManager.regionName = swordStats.swregion;
        gameManager.reg = swordStats.swregion;
        if (swordStats != null) {
            ...
            if (swordStats.swregion == "world") {
                Camera.main.transform.position = new Vector3(swordMasterPosition.x, swordMasterPosition.y + 40f, swordMasterPosition.z - 22f);
                Camera.main.transform.rotation = Quaternion.Euler(60f, 0f, 0);
            }
            if (swordStats.swregion == "raid1") {
                Camera.main.transform.position = new Vector3(swordMasterPosition.x, swordMasterPosition.y + 40f, swordMasterPosition.z + 46f);
                Camera.main.transform.rotation = Quaternion.Euler(40f, 180f, 0);
            }
            if (swordStats.swregion == "raid2") {
                Camera.main.transform.position = new Vector3(swordMasterPosition.x - 47, swordMasterPosition.y + 40f, swordMasterPosition.z);
                Camera.main.transform.rotation = Quaternion.Euler(40f, 90f, 0);
            }
            if (swordStats.swregion == "raid3") {
                Camera.main.transform.position = new Vector3(swordMasterPosition.x, swordMasterPosition.y + 40f, swordMasterPosition.z + 47f);
                Camera.main.transform.rotation = Quaternion.Euler(40f, 180f, 0);
            }
    ...
    public void OnSorceressImageClick() {
        ...
        gameManager.regionName = sorceressStats.scregion;
        gameManager.reg = sorceressStats.scregion;
        if (sorceressStats != null) {
            GameObject focusOnsorceress = sorceressStats.gameObject;
            // Master Object의 위치를 가져옴
            Vector3 sorceressPosition = focusOnsorceress.transform.position;

            if (sorceressStats.scregion == "world") {
                Camera.main.transform.position = new Vector3(sorceressPosition.x, sorceressPosition.y + 40f, sorceressPosition.z - 22f);
                Camera.main.transform.rotation = Quaternion.Euler(60f, 0f, 0);
            }
            if (sorceressStats.scregion == "raid1") {
                Camera.main.transform.position = new Vector3(sorceressPosition.x, sorceressPosition.y + 40f, sorceressPosition.z + 46f);
                Camera.main.transform.rotation = Quaternion.Euler(40f, 180f, 0);
            }
            if (sorceressStats.scregion == "raid2") {
                Camera.main.transform.position = new Vector3(sorceressPosition.x - 47, sorceressPosition.y + 40f, sorceressPosition.z);
                Camera.main.transform.rotation = Quaternion.Euler(40f, 90f, 0);
            }
            if (sorceressStats.scregion == "raid3") {
                Camera.main.transform.position = new Vector3(sorceressPosition.x, sorceressPosition.y + 40f, sorceressPosition.z + 47f);
                Camera.main.transform.rotation = Quaternion.Euler(40f, 180f, 0);
            }
            screenController.ZoomCamera(20);
    ...
    public void OnPriestImageClick() {
        ...
        gameManager.regionName = priestStats.prregion;
        gameManager.reg = priestStats.prregion;
        if (priestStats != null) {
            GameObject focusOnpriest = priestStats.gameObject;
            // Master Object의 위치를 가져옴
            Vector3 priestPosition = focusOnpriest.transform.position;
            if (priestStats.prregion == "world") {
                Camera.main.transform.position = new Vector3(priestPosition.x, priestPosition.y + 40f, priestPosition.z - 22f);
                Camera.main.transform.rotation = Quaternion.Euler(60f, 0f, 0);
            }
            if (priestStats.prregion == "raid1") {
                Camera.main.transform.position = new Vector3(priestPosition.x, priestPosition.y + 40f, priestPosition.z + 46f);
                Camera.main.transform.rotation = Quaternion.Euler(40f, 180f, 0);
            }
            if (priestStats.prregion == "raid2") {
                Camera.main.transform.position = new Vector3(priestPosition.x - 47, priestPosition.y + 40f, priestPosition.z);
                Camera.main.transform.rotation = Quaternion.Euler(40f, 90f, 0);
            }
            if (priestStats.prregion == "raid3") {
                Debug.Log("디버그");
                Camera.main.transform.position = new Vector3(priestPosition.x, priestPosition.y + 40f, priestPosition.z + 47f);
                Camera.main.transform.rotation = Quaternion.Euler(40f, 180f, 0);
            }
            screenController.ZoomCamera(20);
