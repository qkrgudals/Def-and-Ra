...
public class CircularSectorMeshRenderer : MonoBehaviour
{
    ...
    float endRadian;
    float uvRadius = 0.5f;
    Vector2 uvCenter = new Vector2(1.0f, 1.0f);
    ...
    void Start() {
        ...
        meshRenderer = GetComponent<MeshRenderer>(); // Added MeshRenderer
    ...
    void Update() {
        ...
        while (i < count) {
            ...
            vertices[beginNumber].x = beginCos * 3 * radius;
            vertices[beginNumber].y = 0;
            vertices[beginNumber].z = beginSin * 3 * radius;
            vertices[endNumber].x = endCos * 3 * radius;
            vertices[endNumber].y = 0;
            vertices[endNumber].z = endSin * 3 * radius;
