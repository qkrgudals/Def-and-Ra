...
public class EnemyManager : MonoBehaviour {
    ...
    void Update() {
        ...
        for (int i = 0; i < enemyData.Length; i++) {
            ...
            if (timeSinceLastSpawn[i] >= enemyData[i].spawnInterval && enemies.Count < maxEnemiesPerType[i] && stageCleared[currentStage]) {
                ...
                */
                ...
                else if (currentStage == 0 && step == 2 && i == 1) {
                    // 정예 몹 생성
                    SpawnEnemy(i, spawnPositions[0]);
                ...
                else if (currentStage == 0 && step == 3 && i == 2) {
                    // 보스 몹 생성
                    SpawnEnemy(i, spawnPositions[0]);
                ...
                else if (currentStage == 1 && step == 1 && i == 3) {
                ...
                else if (currentStage == 1 && step == 2 && i == 4) {
                ...
                else if (currentStage == 1 && step == 3 && i == 5) {
                ...
                else if (currentStage == 2 && step == 1 && i == 6) {
                    if (enemies.Count < maxEnemiesPerType[i - 1]
                ...
                else if (currentStage == 2 && step == 2 && i == 7) {
                    if (enemies.Count < maxEnemiesPerType[i - 1]
                    + (maxEnemiesPerType[i] - maxEnemiesPerType[i - 1]) / 3)
                        SpawnEnemy(i, spawnPositions[0]);
                    else if (enemies.Count >= maxEnemiesPerType[i - 1]
                ...
                else if (currentStage == 2 && step == 3 && i == 8) {
                    SpawnEnemy(i, spawnPositions[0]);
                ...
                else if (currentStage == 3 && step == 1 && i == 9) {
                    if (enemies.Count < maxEnemiesPerType[i - 1]
                ...
                else if (currentStage == 3 && step == 2 && i == 10) {
                    if (enemies.Count < maxEnemiesPerType[i - 1]
                      + (maxEnemiesPerType[i] - maxEnemiesPerType[i - 1]) / 4)
                        SpawnEnemy(i, spawnPositions[0]);
                    else if (enemies.Count >= maxEnemiesPerType[i - 1]
                ...
                else if (currentStage == 3 && step == 3 && i == 11) {
                    // 보스 몹 생성
                    SpawnEnemy(i, spawnPositions[0]);
